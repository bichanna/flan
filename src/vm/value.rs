...
impl FAtom {
    pub fn build(val: Arc<str>) -> Value {
        Box::new(FAtom(val))
    }
}
...
impl FFunc {
    pub fn build(heap: &mut Heap, func: Function) -> Value {
